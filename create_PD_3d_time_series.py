...
backbone_2d_dataset_path = 'data/body/2d_proposals/mohsen_data_PD.npz'
...
# Options
outpath = 'data/body/3d_time_series/'
lifter_model_path = 'model_checkpoints/body_pose/Mohsens/model_pretrain.pt'

cam_names = ['54138969', '55011271', '58860488', '60457274']
all_cams = ['cam0', 'cam1']
cam_ch_names = ['CH3', 'CH4']

camspace_reproj = True
