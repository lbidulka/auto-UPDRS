...
from utils.mohsen_utils.mocap_dataset import MocapDataset
from utils.mohsen_utils.camera import normalize_screen_coordinates

class H36MDataset(Dataset):
    """Human3.6M dataset including images."""

    def __init__(self, poses_2d, confidences, subject,normalize_2d=True):
...
class H36MDataset_test(Dataset):
    ...
    def __init__(self, pose_2d, pose_3d):
    ...
    def __getitem__(self, idx):
        ...
        sample['confidences']=torch.ones(16*4)
